                ...
                >
                    ...
                    >
                        <animate
                            ...
                            attributeType="XML"
                            attributeName="d"
                            :from="calculatePath(0, 0)"
                            :to="calculatePath(contentWidth, contentHeight)"
                        ...
                        <animate
                            ...
                            attributeType="XML"
                            attributeName="d"
                            :to="calculatePath(0, 0)"
                            :from="calculatePath(contentWidth, contentHeight)"
                            :dur="animationDuration"
                            begin="indefinite"
                            fill="freeze"
                        />
...
@Options({})
export default class ContentMarkerComponent extends Vue {
    declare $refs: {
        marker: SVGElement
    }
...
.icon-visible,.content-visible {
    visibility: visible;
}
.icon-invisible,.content-invisible {
    visibility: hidden;
}
.icon-visible {
